...
export const Level2Metadata: LevelMetadata = {
    ...
    actions: [
        { location: "Ingredient Storage", action: "take", item: "Raw Ingredients", position: { x: 1, y: 0 } },
        { location: "Prep Station", action: "put", item: "Ingredients", position: { x: 2, y: 1 } },
        { location: "Prep Station", action: "take", item: "Prepared Ingredients", position: { x: 2, y: 1 } },
        { location: "Stove", action: "put", item: "Ingredients", position: { x: 3, y: 2 } },
        { location: "Stove", action: "take", item: "Cooked Food", position: { x: 3, y: 2 } },
        { location: "Plate Station", action: "put", item: "Food", position: { x: 2, y: 3 } },
        { location: "Plate Station", action: "take", item: "Plated Meal", position: { x: 2, y: 3 } },
        { location: "Serving Counter", action: "put", item: "Meal", position: { x: 1, y: 4 } },
        { location: "Trash Zone", action: "put", item: "Waste", position: { x: 3, y: 4 } },
        { location: "Sink", action: "take", item: "Dirty Dishes", position: { x: 1, y: 5 } },
        { location: "End Position", action: "finish", item: "Finished", position: { x: 0, y: 2 } }
    ],
