...
export class StartScene extends Scene {
    ...
    create() {
        ...
        // Credits button
        const creditsBtn = this.add.image(W / 2, H * 0.55 + playBtn.displayHeight + 20, 'credits-btn')
            .setDepth(20)
            .setInteractive({ useHandCursor: true });
        creditsBtn.on('pointerover', () => creditsBtn.setAlpha(0.85));
    ...
    private buildLevelOverlay(): GameObjects.Container {
        ...
        const panelW = 640;
        const panelH = 420;
        const panel = this.add.rectangle(W / 2, H / 2, panelW, panelH, 0x1a1a2e, 1);
        ...
        // Level 1 button
        const lvl1Bg = this.add.rectangle(W / 2, H / 2 - 20, 460, 90, 0x2d2d2d)
        ...
        lvl1Bg.on('pointerover', () => { lvl1Bg.setFillStyle(0x4a4aaa); lvl1Text.setColor('#ffff88'); });
        lvl1Bg.on('pointerout', () => { lvl1Bg.setFillStyle(0x2d2d2d); lvl1Text.setColor('#ffffff'); });
